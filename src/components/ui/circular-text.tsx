...
const CircularText: React.FC<CircularTextProps> = ({
  ...
  return (
    <div className="relative">
      <motion.div
        initial={{ rotate: 0 }}
        className={`relative mx-auto rounded-full w-[200px] h-[200px] text-[#e3ddda] font-black text-center cursor-pointer origin-center ${className}`}
        animate={controls}
      ...
      >
        <ArrowRight
          className="text-xl group-hover:-rotate-45 transition-all ease-linear duration-200"
          size={50}
        />
      </Link>
    </div>
